...
def Crawl_through_subgraph_node(node_Direction,Set_node,Dico_contig_degree) :
...
def graph_selection(List_nodes,Gfa_file,mode,ouptut_file) :
	# get graph infos
...
if __name__ == "__main__":
	...
	graph_selection(List_nodes,Gfa_file,mode,ouptut_file)
